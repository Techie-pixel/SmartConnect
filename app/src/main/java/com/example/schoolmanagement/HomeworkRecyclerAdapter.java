...
public class HomeworkRecyclerAdapter extends RecyclerView.Adapter<HomeworkRecyclerAdapter.VH> {

    public interface OnActionListener {
        void onViewImages(HomeworkListFragment.HomeworkItem item);

        void onSubmit(HomeworkListFragment.HomeworkItem item);
    }

    private final List<HomeworkListFragment.HomeworkItem> items;
    private final OnActionListener listener;
    private final SimpleDateFormat df = new SimpleDateFormat("dd MMM, hh:mm a", Locale.getDefault());

    public HomeworkRecyclerAdapter(List<HomeworkListFragment.HomeworkItem> items, OnActionListener l) {
        this.items = items;
        this.listener = l;
    }
    ...
    public void onBindViewHolder(@NonNull VH h, int position) {
        HomeworkListFragment.HomeworkItem it = items.get(position);
