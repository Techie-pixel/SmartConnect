...
public class twelvecommercehome extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twelvecommercehome);
    ...
    private void setupToolbar() {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("12th Commerce Dashboard");
    ...
    private void setupCardClickListeners() {
        findViewById(R.id.assignment).setOnClickListener(v -> {
            Intent intent = new Intent(twelvecommercehome.this, studentassignment.class);
