...
public class twelveartshome extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twelveartshome);
    ...
    private void setupToolbar() {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("12th Arts Dashboard");
    ...
    private void setupCardClickListeners() {
        findViewById(R.id.assignment).setOnClickListener(v -> {
            Intent intent = new Intent(twelveartshome.this, studentassignment.class);
        ...
        findViewById(R.id.notices).setOnClickListener(v -> {
            ...
            noticeIntent.putExtra("stream", "Arts");
