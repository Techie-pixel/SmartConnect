...
public class studentcalender extends AppCompatActivity
    ...
    private static final String CHANNEL_ID = "student_reminder_channel";
    private final List<ReminderItem> reminderList = new ArrayList<>();
    private static final String PREFS_KEY = "StudentReminders";
    private static final String PREFS_NAME = "StudentReminderPrefs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_studentcalender);
        ...
        // Animate calendar view after delay
        mainContent.postDelayed(() -> {
            if (calendarView != null) {
                UIAnimator.animateImageView(calendarView, 500);
            }
            if (selectedDateText != null) {
                UIAnimator.animateTextView(selectedDateText, 600);
            }
        }, 400);
    }
    ...
    private void initializeViews() {
        ...
        selectedDateText = findViewById(R.id.todayDateText);
    ...
    private void setupCalendar() {
        ...
        MaterialButton addReminderBtn = findViewById(R.id.addEventBtn);
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(
                    CHANNEL_ID, "Student Reminders", NotificationManager.IMPORTANCE_HIGH);
            channel.setDescription("Student calendar reminders");
    ...
    private void ensureNotificationPermission() {
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (granted != PackageManager.PERMISSION_GRANTED) {
                requestPermissions(new String[] { android.Manifest.permission.POST_NOTIFICATIONS }, 2003);
            }
        }
    }
