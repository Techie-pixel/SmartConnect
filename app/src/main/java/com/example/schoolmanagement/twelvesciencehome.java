...
public class twelvesciencehome extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twelvesciencehome);
    ...
    private void setupToolbar() {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("12th Science Dashboard");
    ...
    private void setupCardClickListeners() {
        findViewById(R.id.assignment).setOnClickListener(v -> {
            Intent intent = new Intent(twelvesciencehome.this, studentassignment.class);
            intent.putExtra("singleCategory", true);
            intent.putExtra("std", "12");
