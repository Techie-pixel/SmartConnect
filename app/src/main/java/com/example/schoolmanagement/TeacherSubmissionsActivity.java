...
public class TeacherSubmissionsActivity extends AppCompatActivity {
    ...
    private final Set<String> myAssignmentKeys = new HashSet<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDelete = findViewById(R.id.btnDeleteAssignment);
        ...
        btnDelete.setOnClickListener(v -> {
            UIAnimator.animateClick(v);
            v.postDelayed(this::showDeleteAssignmentDialog, 150);
        });
        ...
        loadMyAssignmentKeys();
    }

    private void loadMyAssignmentKeys() {
        ...
        submissionsRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot a : snapshot.getChildren()) {
                    String key = a.getKey();
                    if (key == null || !myAssignmentKeys.contains(key))
                        continue;
    ...
    private void showDeleteAssignmentDialog() {
        if (myAssignmentKeys.isEmpty()) {
            new androidx.appcompat.app.AlertDialog.Builder(this)
                    .setMessage("No assignments to delete")
                    .setPositiveButton("OK", null)
                    .show();
            return;
        }
        java.util.List<String> keys = new java.util.ArrayList<>(myAssignmentKeys);
        ...
        b.setPositiveButton("Delete", (d, w) -> {
            if (sel[0] >= 0) {
                ...
                if (category != null) {
                    // Delete from Assignments and Submissions
