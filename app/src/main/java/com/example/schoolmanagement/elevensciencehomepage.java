...
public class elevensciencehomepage extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elevensciencehomepage);
    ...
    private void setupToolbar() {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("11th Science Dashboard");
    ...
    private void setupViewFlipper() {
        if (imageViewFlipper != null) {
            ...
            // Animate view flipper
            UIAnimator.animateImageView(imageViewFlipper, 600);
        }
    }
    ...
    private void setupUserProfile() {
        ...
        if (headerView != null) {
            ...
            if (studentName == null || studentName.isEmpty()) {
                ...
                // Animate username
                UIAnimator.animateTextView(usernameText, 300);
            }
        }
    }
    ...
    private void setupCardClickListeners() {
        findViewById(R.id.assignment).setOnClickListener(v -> {
            Intent intent = new Intent(elevensciencehomepage.this, studentassignment.class);
            intent.putExtra("singleCategory", true);
            intent.putExtra("std", "11");
            intent.putExtra("stream", "Science");
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            finish();
        });

        findViewById(R.id.notices).setOnClickListener(v -> {
            Intent noticeIntent = new Intent(this, StudentNoticesActivity.class);
            noticeIntent.putExtra("std", "11");
            noticeIntent.putExtra("stream", "Science");
            startActivity(noticeIntent);
        });

        findViewById(R.id.event).setOnClickListener(v -> {
