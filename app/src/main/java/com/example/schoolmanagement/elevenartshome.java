...
public class elevenartshome extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elevenartshome);
    ...
    private void setupToolbar() {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("11th Arts Dashboard");
    ...
    private void setupCardClickListeners() {
        findViewById(R.id.assignment).setOnClickListener(v -> {
            Intent intent = new Intent(elevenartshome.this, studentassignment.class);
